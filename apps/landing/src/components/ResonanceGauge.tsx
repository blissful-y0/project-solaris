    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <div className="text-text/70 text-sm leading-relaxed space-y-3">
          <p>
            2174년, 핵화염이 걷힌 자리에 인류가 남았습니다. 하늘은 재로 덮였고,
            대지는 방사선에 잠겼습니다. 살아남은 것은 사람만이 아니었습니다 —
            방사선이 인류의 유전자에 지울 수 없는 상흔을 새겼습니다.
            <br /> 피폭 변이. 돔이 세워지고 세대가 바뀌어도, 이 변이는 모든
            인간의 DNA에 조용히 남아 있습니다. 대부분은 평생 그 존재를 알지
            못합니다. 발현되지 않고, 감지되지 않고, 이름조차 붙지 않은 채
            유전자의 가장 깊은 곳에서 침묵합니다. <br />
            공명율은 이 침묵에 균열을 내는 열쇠입니다. 헬리오스 코어와 인간 정신
            사이의 연결 깊이를 수치화한 것으로, 15번째 생일에 공명 측정을 통해
            확정됩니다. <br />
            시냅스 재편성이 완료되는 그 시점 이후, 수치는 다시 바뀌지 않습니다.
            <br />
            대부분의 시민은 15에서 79 사이에 머뭅니다. <br />
          ...
          >
            그러나 이 숫자가 극단에 도달한 자들은, 침묵하던 변이를 깨우게
            됩니다.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="text-sm leading-relaxed space-y-3">
          ...
          <div className="text-text/60 space-y-2">
            <p>
              높으면 시스템 위에서 깨어납니다. 강력하지만 시스템에 묶입니다.
            </p>
            <p>
              낮으면 시스템 밖에서 깨어납니다. 불안정하지만 시스템이 잡을 수
              없습니다.
            </p>
          </div>
        </div>
