...
const FACTIONS: FactionData[] = [
  {
    ...
    description: [
      "이들은 돔이 세워진 날부터 존재했다. 솔라리스에 법이 제정되기 이전부터 살아 있었고, 그렇게 때로는 규칙보다 먼저 움직인다.\n시민보안국은 묻지 않는다 — 명령한다.",
      "구성원 전원 동조율 80 이상, 공명 강화 훈련 이수. 헬리오스가 선택한 자들.\n이들은 마지막 남은 인류의 안식처를 지키려 한다",
      "모든 것을 희생해서라도————",
    ],
    tags: ["질서", "충성", "보호"],
    tone: "amber",
  ...
  },
  {
    ...
    quote: "우리는 추방당한 자들이다.\n하지만 꿈만은 빼앗기지 않았다.",
    description: [
      "시스템이 잡아내지 못하는 주파수. 감지망 바깥의 잡음.\n동조율이 너무 낮아 쫓겨난 자들, 혹은 너무 많은 것을 알게 되어 스스로 추방된 자들.",
      "솔라리스 밖은 죽음의 땅이라고 배웠다. 절반은 맞다.\n하지만 그곳에는 도시가 빼앗은 것이 있다 — 밤마다 찾아오는 형체 없는 이미지, 꿈.",
      "두려웠다, 그러나 그리웠다. 마지막엔 깨닫는다.\n이것이야말로 인간이라는 증거라는 걸.",
    ],
    tags: ["자유", "진실", "인간성"],
    tone: "magenta",
    heroChoice: "truth",
