...
export const SYSTEMS: SystemInfo[] = [
  {
    ...
    sections: [
      {
        heading: "판정 방식",
        body: "AI GM이 캐릭터의 스탯, 동조율, 상황 맥락을 종합하여 전투 결과를 판정합니다. 서술의 논리성과 창의성이 판정에 영향을 줍니다.",
      },
      {
        heading: "전투 흐름",
  ...
  },
  {
    ...
    sections: [
      {
        heading: "동조율 등급",
        body: "0-39 일반 | 40-59 감응 | 60-79 각성 | 80+ 초월. 동조율이 높을수록 강력한 능력을 사용할 수 있지만, 인간성을 잃어갈 위험이 따릅니다.",
      },
      {
        heading: "스킬 체계",
        body: "동조율 등급에 따라 해금되는 스킬이 결정됩니다. 각 진영별 고유 스킬 트리가 존재하며, 선택에 따라 캐릭터의 전투 스타일이 달라집니다.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      {
        heading: "캐릭터 시트",
        body: "기본 정보, 동조율, 진영 소속, 배경 스토리를 설정합니다. 세계관에 맞는 캐릭터를 구성하기 위한 가이드라인을 제공합니다.",
      },
      {
        heading: "가이드라인",
