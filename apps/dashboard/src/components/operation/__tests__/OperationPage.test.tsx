...
describe("OperationPage", () => {
  ...
  it("초기 상태(미승인)에서 AccessDenied를 표시한다", () => {
  ...
  it("DEV 토글에서 승인 상태로 전환하면 OperationHub를 표시한다", async () => {
    const user = userEvent.setup();
    render(<OperationPage />);

    const approvedBtn = screen.getByText("[DEV] 승인");
